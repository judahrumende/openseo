...
// Mirrors SamSetupGate (src/client/features/sam/SamSetupGate.tsx), reworded
// for Content Brief.
export function ContentBriefSetupGate({
  errorMessage,
  isRefetching,
  onRetry,
}: {
      ...
      <div className="rounded-2xl border border-base-300 bg-base-100 p-6 md:p-7 space-y-5">
        <div className="flex items-start gap-3">
          ...
          <div className="max-w-3xl space-y-1.5">
            <h2 className="text-xl font-semibold">Enable Content Brief</h2>
            <div className="text-sm text-base-content/68">
              Content Brief writes with an AI model and needs an OpenRouter API
